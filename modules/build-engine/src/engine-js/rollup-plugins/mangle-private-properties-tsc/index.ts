...
export interface IManglePrivatePropertiesOptionsTsc {
 ...
 */
export async function rpManglePrivatePropertiesTsc(rawOptions: IManglePrivatePropertiesOptionsTsc, meta?: any): Promise<rollup.Plugin[]> {
    const name = 'cc-mangle-private-properties-tsc';
